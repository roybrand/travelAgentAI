...
GUIDES = {
    ...
    "TLV": {
        ...
        "adventures": [
            {"name": "Day trip to Jerusalem", "why": "The Old City is under an hour away", "tags": ["old-town"]},
            {"name": "Float in the Dead Sea", "why": "Mineral spas and desert scenery", "tags": ["spa"]},
            {"name": "Sunset promenade walk", "why": "From Jaffa to the marina along the sea", "tags": ["beachfront", "quiet"]},
            {"name": "Rooftop and club night", "why": "Tel Aviv's nightlife runs late", "tags": ["nightlife", "rooftop-bar"]},
        ],
